...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/woman-eating-seafood-dish-with-salmon_23-2150463267.jpg",
          alt: "Guest 2",
        },
        {
          src: "http://img.b2bpic.net/free-photo/friends-having-fun-their-reunion_23-2149215791.jpg",
          alt: "Guest 3",
        },
        {
          src: "http://img.b2bpic.net/free-photo/group-diverse-friends-are-having-dinner-together_53876-40927.jpg",
          alt: "Guest 4",
        },
        {
          src: "http://img.b2bpic.net/free-photo/friends-having-fun-their-reunion_23-2149215775.jpg",
          alt: "Guest 5",
        },
      ]}
  ...
  <div id="menu" data-section="menu">
      ...
      products={[
        ...
        },
        {
          ...
          price: "Signature",
          imageSrc: "http://img.b2bpic.net/free-photo/green-curry-with-eggs-black-cups-with-lemon-lemongrass-chili-tomatoes_1150-25741.jpg",
        },
        {
          id: "p3",
          name: "Rice & Curry (10-Dish)",
          price: "Traditional",
          imageSrc: "http://img.b2bpic.net/free-photo/indian-food-arrangement-top-view_23-2148723466.jpg",
        },
        {
          id: "p4",
          name: "Brinjal Pasta (V)",
          price: "Vegan Choice",
          imageSrc: "http://img.b2bpic.net/free-photo/pasta-with-pesto-parmesan_23-2152015849.jpg",
        },
        {
          id: "p5",
          name: "Vegetable Roti",
          price: "Appetizer",
          imageSrc: "http://img.b2bpic.net/free-photo/indian-delicious-roti-with-copy-space_23-2149073355.jpg",
        },
        {
          id: "p6",
          name: "Coastal Dessert",
          price: "Sweet",
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        },
        {
          ...
          company: "Local",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/medium-shot-smiley-women-with-pizza_23-2149333835.jpg",
        },
        {
          id: "3",
          name: "Elena R.",
          ...
          company: "Spain",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/friends-birthday-good-summer-sunny-day_146671-18997.jpg",
        },
        {
          id: "4",
          name: "David W.",
      ...
      columns={[
        {
          ...
          items: [
            {
              label: "100/11 B, Beach Rd, Negombo",
              href: "#",
            },
          ],
        },
